...
using CompanyName.MyMeetings.Modules.UsersMI.Infrastructure.Configuration.DataAccess.TypeConfigurations;
using CompanyName.MyMeetings.Modules.UsersMI.Infrastructure.InternalCommands;
using CompanyName.MyMeetings.Modules.UsersMI.Infrastructure.Outbox;
...
namespace CompanyName.MyMeetings.Modules.UsersMI.Infrastructure;
...
public class UserAccessContext : IdentityDbContext<ApplicationUser, Role, Guid, IdentityUserClaim<Guid>, IdentityUserRole<Guid>, IdentityUserLogin<Guid>, IdentityRoleClaim<Guid>, IdentityUserToken<Guid>>
{
    ...
    {
        optionsBuilder.UseSqlServer(_databaseConfiguration.ConnectionString, builder =>
        {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(Assemblies.Infrastructure);
