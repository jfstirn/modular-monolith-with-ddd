...
internal class IdentityModule : Autofac.Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        // Password hashing is done by a custom service. Do not use ASP.NET Core Identity's default password hasher.
        serviceCollection.AddScoped<IPasswordHasher<ApplicationUser>, CustomPasswordHasher>();
